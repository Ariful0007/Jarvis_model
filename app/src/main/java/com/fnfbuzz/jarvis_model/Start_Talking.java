...
public class Start_Talking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start__talking);
    ...
    private void initilizeTextTosepech() {
        text=new TextToSpeech(Start_Talking.this, new TextToSpeech.OnInitListener() {
            @Override
            public void onInit(int status) {
                if (text.getEngines().size()==0) {
                    Toast.makeText(Start_Talking.this, "Not Found Engine", Toast.LENGTH_SHORT).show();
                }
                else {

                    speck("Hi,Welcome to jarvis system.?");
            ...
            speechRecognizer.setRecognitionListener(new RecognitionListener() {
                ...
                public void onResults(Bundle results)
                {
                    ...
                    if (stringArrayList !=null) {
                        ...
                        Toast.makeText(Start_Talking.this, "Result :"+kipper, Toast.LENGTH_LONG).show();
                    }
                    else {
                        Toast.makeText(Start_Talking.this, "Speack Again..", Toast.LENGTH_SHORT).show();
                    }
